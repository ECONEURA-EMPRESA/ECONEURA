          ...
          <div className="flex-1">
            ...
            <div className="flex items-baseline gap-4 mb-4">
              ...
              <motion.div
                ...
                className={`flex items-center gap-1.5 px-4 py-1.5 rounded-full text-sm font-bold backdrop-blur-sm ${
                  isAboveTarget 
                    ? darkMode 
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-2">
          {agents.map((agent, index) => (
            ...
            >
              <div className={`flex items-center justify-center w-12 h-12 rounded-lg text-xl font-bold ${
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            style={{ 
              focusRingColor: rgba(accentColor, 0.2)
            }}
          >
