...
import { agentRepository } from '../../infra/persistence/InMemoryAgentRepository';
...
function detectAgentIntent(
    ...
    const agents = agentRepository.findByNeuraKey(neuraKey);
